...
//      +-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------+
        ...
        KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_BSPC ,KC_BSPC ,
                KC_LSFT ,KC_LCTL ,KC_LGUI ,KC_LANG2,KC_TAB  ,KC_SPC  ,KC_LANG1,KC_TRNS, KC_TRNS ,KC_RCTL
//      +-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------+
    ),
    LAYOUT_universal(
//      +-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------+
...
//      +-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------+FN_MC
        ...
        KC_TRNS   ,KC_TRNS   ,KC_MY_BTN2,KC_MY_SCR ,KC_MY_BTN1,KC_TRNS   ,KC_TRNS   ,KC_MY_BTN1,KC_MY_SCR ,KC_MY_BTN2,KC_TRNS   ,KC_TRNS   ,
        KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,
                   KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_TRNS   ,KC_MY_SCR
//      +-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------++-------+
    )
