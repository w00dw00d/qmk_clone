...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, _______, KC_MHEN, KC_SPC,  KC_HENK, MO_LO,            KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  [_LOWER] = LAYOUT(
    RESET,   AT_TS,   AT_TE,   AT_PW,   _______, _______, _______, _______, _______, KC_INS, JP_CIRC, KC_BSLS, KC_ASTG, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, JP_LBRC, JP_RBRC, \
    MO_LO,   _______, _______, CL_PU,   CL_PD,   _______, _______, JP_LBRC, JP_RBRC, JP_AT,   KC_GRV,  _______, \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, JP_UNDS, KC_PGUP, _______, \
